...
syntax keyword asmLabel NOP INCA DECA INCB RAM_AL RAM_BL RAM_A RAM_B INCSP DECSP PUSHA POPA PEEKA PEEKAR PUSHAR PUSHB POPB PEEKB SUM SUB SHR SHL AND CMPA CMPB JMP JMPR JMPRZ JMPRN JMPRC JMPRNZ JMPRNN JMPRNC JMPA JMPAR A_B B_A B_AH AL_rB A_rB rB_AL rB_A A_SP SP_A A_SEC SEC_A RAM_NDX INCNDX NDX_A A_NDX MEM_A MEM_AH AL_MEM CALL CALLR RET _KEY_A DRW RAM_DRW HLT
