...
_start:
  ...
  RAM_B 0x8008 RAM_AL 0x88 DRW
  RAM_B 0x8009 RAM_AL 0xFF DRW
  RAM_B 0x800A RAM_AL 0xFF DRW
  RAM_B 0x800B RAM_AL 0xFF DRW
  RAM_B 0x800C RAM_AL 0xFF DRW
  RAM_B 0x800D RAM_AL 0xFF DRW
  RAM_B 0x800E RAM_AL 0xFF DRW
  RAM_B 0x800F RAM_AL 0xFF DRW
